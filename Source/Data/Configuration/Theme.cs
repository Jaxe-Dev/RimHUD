...
namespace RimHUD.Data.Configuration
{
    internal static class Theme
    {
        ...
        public static RangeOption RefreshRate { get; } = new RangeOption(5, 0, 30, Lang.Get("Theme.RefreshRate"), value => (value * 100) + Lang.Get("Theme.RefreshRateUnits"), Lang.Get("Theme.RefreshRateDesc"));
        ...
        public static RangeOption HudHeight { get; } = new RangeOption(395, 300, 1500, Lang.Get("Theme.HudHeight"));
        ...
        public static RangeOption InspectPaneTabWidth { get; } = new RangeOption(85, 72, 150, Lang.Get("Theme.InspectPaneTabWidth"));
