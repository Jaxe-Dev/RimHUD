...
public static class Theme
{
  ...
  [Setting("Text", "Regular")] public static TextStyle RegularTextStyle { get; } = new(Lang.Get("Theme.TextStyleRegular"), null, DefaultBaseFontSize, 7, 20, 100, 100, 250, static _ => UpdateTextStyles());
  [Setting("Text", "Large")] public static TextStyle LargeTextStyle { get; } = new(Lang.Get("Theme.TextStyleLarge"), RegularTextStyle, 9, 0, 24, 100, 100, 250);
  [Setting("Text", "Small")] public static TextStyle SmallTextStyle { get; } = new(Lang.Get("Theme.TextStyleSmall"), RegularTextStyle, -1, -5, 0, 100, 100, 250);
  ...
  [Setting("Colors", "Critical")] public static ColorSetting CriticalColor { get; } = new(ColoredText.ThreatColor, Lang.Get("Theme.CriticalColor"));
  [Setting("Colors", "Warning")] public static ColorSetting WarningColor { get; } = new(ColoredText.WarningColor, Lang.Get("Theme.WarningColor"));
