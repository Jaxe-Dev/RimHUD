  ...
  internal class Dialog_Config : WindowPlus
  {
    ...
    protected override void DrawContent(Rect rect)
    {
      try
      {
        ...
        GUIPlus.DrawText(grid[2], "Version " + Mod.Version + (Prefs.DevMode && Mod.DevMode ? "[DEV MODE - Click to disable]".Colorize(Color.yellow) : null), style: Theme.SmallTextStyle, alignment: TextAnchor.LowerRight);
