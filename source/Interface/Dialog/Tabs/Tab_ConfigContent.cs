...
namespace RimHUD.Interface.Dialog.Tabs
{
  public sealed class Tab_ConfigContent : Tab
  {
    ...
    private static void ShowNeedBarFloatMenu() => HudContent.BarElements.Select(static item => new FloatMenuOption(item.Label, () => Find.WindowStack!.Add(new FloatMenu(new List<FloatMenuOption>
    {
