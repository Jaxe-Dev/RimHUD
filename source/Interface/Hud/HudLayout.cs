...
namespace RimHUD.Interface.Hud
{
  public static class HudLayout
  {
    ...
    public static Rect GetConfigButtonRect(Rect rect, bool top) => new(rect.xMax - ConfigButtonSize, top ? rect.y : rect.yMax - ConfigButtonSize, ConfigButtonSize, ConfigButtonSize);
